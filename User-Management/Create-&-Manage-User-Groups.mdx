...
description: "When an organization has added multiple users, it can simplify project access management by creating User Groups. A User Group allows you to assign access…"
---
...
1. Navigate to the [User Group](https://dataprovider.voxdash.com/org/userGroups) section on the organization page.
...
Click the **Invite** button to send a notification to the selected users. 
