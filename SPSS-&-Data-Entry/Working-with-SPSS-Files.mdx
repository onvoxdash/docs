...
* Store all responses as numeric values with clear labels.
VoxDash accepts open-ended text and code it using AI, then saves both the original text and the coded numeric value. Visit [AI-Open Ended Analysis](/AI-&-Analysis/AI-Open-Ended-Analysis)
...
3. **Maps Variables:**  
   * Prefix variable names with `Map_` to create a map for analytics easier.
