...
* Store all responses as numeric values with clear, human-readable labels.
VoxDash accepts open-ended text and code it using AI, then save both the original text and the coded numeric value. visit [AI-Open Ended Analysis](/AI-&-Analysis/AI-Open-Ended-Analysis)
...
3. **Maps Variables:**  
   * Prefix variable names with `Map_` to exclude them from analysis.  
