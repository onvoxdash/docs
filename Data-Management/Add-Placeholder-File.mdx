...
1. **Upload a file** following the steps in [Bulk File Upload](/Data-Management/Bulk-File-Upload) and [Multiple File Bulk Upload](/Data-Management/Multi-Folder-Upload).
