...
description: "A placeholder file is a small, usually empty file used to preserve a folder structure or indicate where future files will be added. It helps the platform…"
---
...
1. Navigate to the [Data Project](https://dataprovider.voxdash.com/projects) section of your project. Create a new project using [Bulk File Upload](/Data-Management/Bulk-File-Upload) or [Multiple File Bulk Upload](/Data-Management/Multi-Folder-Upload).
