...
1. Navigate to the [Data Project](https://dataprovider.voxdash.com/projects) section of your project. Create a new projest using [Bulk File Upload](/Data-Management/Bulk-File-Upload) or [Multiple File Bulk Upload](/Data-Management/Multi-Folder-Upload).
