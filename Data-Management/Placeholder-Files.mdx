...
1. Navigate to the [Data Project](https://dataprovider.voxdash.com/projects) section of your project. Create a new projest by using [Bulk File Upload](/Data-Management/Bulk-File-Upload) and [Multiple File Bulk Upload](/Data-Management/Multi-Folder-Upload).
