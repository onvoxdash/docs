...
### **Steps to Follow**
The process is identical to the one described in the *Terms and Conditions Section in the **Data Project**. Use Wizard 10 to access and complete and add a T\&C like the previouse method (Method 1), or use the previousely added conditions.
<Frame>
