...
description: "VoxDash provides interactive map visualizations to help you analyze survey responses geographically. These maps display insights based on respondents’…"
---
...
**Note:** Users can use the burger menu on the top right corner of each map to download different versions of the map and use them in their analysis.
...
The Base Map shows the percentage of responses by state or region. This provides a quick overview of where most responses come from.
...
**Notes:** 
 1. You can add customized map during survey data entry process. Learn more [here.](/docs/Survey-&-Data-Entry/Survey-Variable-Mapping)
 
 2. You must be logged into your account to access customization features.
...
4. **Finish Builing Your Aggregate Map**: Click on **Finish** to end the process and add the aggregated map to the custome map list.
...
Learn more about map drilldown [here](https://help.voxdash.com/Maps-&-Visualizations/Drilldown-Map-Examples#drilldown-map-examples).
## Conclusion
