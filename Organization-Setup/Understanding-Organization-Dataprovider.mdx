---
title: "What is an Organization Data Provider Panel?"
...
**Important Note:** Each organization in VoxDash has its own data, users and SaaS plan, and the owner can create different organization to  manage everything better. Later the owner can **switch** between the organization through the header.
...
* View all uploaded [Data Project](https://dataprovider.voxdash.com/projects)
...
[Everything You Need to Know About Data Provider Panel](/Data-Management)
...
4. **Create New Organization:** Click on the **Add new organization** to create another organization based on your needs. You can use your main email or other verified emails.
