...
<CardGroup cols={3}>
  <Card title="Users" icon="user" href="/files/import-export/organization_users_sample.xlsx">
    organization_users_sample.xlsx
  </Card>
  <Card title="User groups" icon="user-group" href="/files/import-export/organization_user_groups_sample.xlsx">
    organization_user_groups_sample.xlsx
  </Card>
  <Card title="Admins" icon="user-shield" href="/files/import-export/organization_users_sample.xlsx">
