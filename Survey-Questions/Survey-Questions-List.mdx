...
description: "The Survey Questions Section provides users with centralized access to all questions from every data project added in VoxDash. This page offers a structured…"
---
...
* **My Data Profiles:** Limit the result by data profiles created or owned by your account.
...
* **Data Mode:** Filter based on the method used to collect the data.
