...
description: "When users sign up for VoxDash, a personal profile page is automatically created. This profile serves as a central place to manage personal details, showcase…"
---
...
2. Navigate to the first tab in the [Organization Page](https://dataprovider.voxdash.com/org/setupProfile) from the main dashboard.  

<Frame>
  <img src="/images/person-profile.png" alt="Setup profile" style={{ borderRadius: '0.5rem' }} />
</Frame>

**Note:**  This section is also visible under your account settings and can be updated at any time.
<Frame>
  <img src="/images/person-profile-account-settings.png" style={{ borderRadius: '0.5rem' }} />
</Frame>
