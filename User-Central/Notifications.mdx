...
description: "Notifications inform users about events, changes, and actions across the platform. Any meaningful state change, system event, or user-facing action generates…"
---
