...
**What they can do:** 
Almost everything the owner can, including accessing data through the [Date Provider Panel](https://dataprovider.voxdash.com/) and [Public Panel](https://www.voxdash.com/).
**What they cannot do:**
