...
* If you haven't add the user from user management but you gave access to a user by using its email, the user will have automatically added to your users and you can edit the information in [User Management table](https://dataprovider.voxdash.com/org/userManagement).
