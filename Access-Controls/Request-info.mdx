...
description: "In some cases, data may be publicly visible on the platform, but the provider requires additional information from users before granting full access. When…"
---
