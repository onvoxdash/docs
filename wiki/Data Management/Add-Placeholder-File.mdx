...
1. **Upload a file** following the steps in [Bulk Upload](/wiki/Data Management/Bulk-File-Upload) and [Multiple File Bulk Upload](/wiki/Data Management/Multi-Folder-Upload).
