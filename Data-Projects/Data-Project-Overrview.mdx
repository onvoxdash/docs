...
<Frame>
  <img src="/images/public-limit.png" alt="data-project-limitation-page" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
The **Claim, Report, or Improve Dataset** feature allows users to contribute to dataset accuracy, ownership verification, and overall data quality. This helps maintain a trusted and reliable data environment across the platform.

<Frame>
  <img src="/images/claim.png" alt="data-project-claim
  " style={{ borderRadius: '0.5rem' }} />
</Frame>

### Report or Improve a Dataset

Users can report issues or suggest improvements for any dataset by submitting additional information directly from the dataset page. This feature is designed to help maintain accurate, complete, and up-to-date dataset records.

Users may provide:

* Corrections to dataset information
...
<Frame>
  <img src="/images/improve2.png" alt="data-project-claim
  " style={{ borderRadius: '0.5rem' }} />
</Frame>
<Frame>
  <img src="/images/improve.png" alt="data-project-claim
  " style={{ borderRadius: '0.5rem' }} />
</Frame>

To submit a report or improvement:

1. Open the dataset page.
2. Select **Report** or **Improve Dataset**.
3. Enter the requested information and supporting details.
4. Submit the request for review.

All submitted changes are reviewed by administrators or authorized dataset owners before being published.

### Claim a Dataset

Dataset co-owners can claim ownership of a dataset to verify and manage its public availability and information.

When a dataset is claimed:
...
<Frame>
  <img src="/images/claim2.png" alt="data-project-claim
  " style={{ borderRadius: '0.5rem' }} />
</Frame>

This process helps ensure that dataset ownership, permissions, and public information remain accurate and secure. For more information read [claiming a dataset](/Access-Controls/claim)
