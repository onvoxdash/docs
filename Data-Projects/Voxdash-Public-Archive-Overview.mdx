...
All VoxDash users can browse, view, and analyze data within the VoxDash Public Archive, no special permissions are required, just log into your VoxDash account and navigate to the **Data project**  tab, then select [VoxDash Public Archive](https://www.voxdash.com/PublicArchive) from the list of organizations.
