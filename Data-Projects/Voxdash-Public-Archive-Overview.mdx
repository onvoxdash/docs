...
description: "The VoxDash Public Archive is a dedicated organization within the VoxDash platform, created by our team to provide users with open access to publicly…"
---

The [VoxDash Public Archive](https://www.voxdash.com/publicarchive) is a dedicated organization within the VoxDash platform, created by our team to provide users with open access to publicly available survey datasets. These datasets have been collected from a wide range of public sources across the internet and compiled into a single, searchable repository for your convenience.
